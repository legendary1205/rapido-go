...
- **خلوتی هر کانفیگ** — نام هر کانفیگ در اشتراک با میزان شلوغی همان لحظه‌اش تمام می‌شود (`🇩🇪 Germany 🟢 23%`؛ سبز زیر ۴۰٪، زرد زیر ۷۰٪، نارنجی زیر ۹۰٪، قرمز بالاتر)، از روی اتصال‌های زنده‌ی همان پورت روی نودی که هاست به آن اشاره می‌کند. با نوشتن `{LOAD}` در «عنوان» هاست خودتان جایش را تعیین می‌کنید و می‌توانید خلوت‌ترین‌ها را اول لیست کنید.
